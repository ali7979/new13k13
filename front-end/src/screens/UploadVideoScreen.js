    ...
    return (
        ...
        <form id="Web_1920__5">
          ...
          <NavLink to="/">  <img id="Full_transparent" src={Full_transparent}/></NavLink>
            ...
            <div >
                <input id="Title" placeholder="Title" onChange={e=>setTitle(e.target.value)}required ></input>
            </div>
            <div >
            <input id="Description" placeholder="Description" onChange={e=>setDescription(e.target.value)}required></input>
            </div>
            <div  onChange={e=>setVisibility(e.target.value)}>
            <div id="Group_76">
                <div id="Public">
                    <span>Public</span>
                </div>
           ...
           <NavLink to="/profile"> <img id="Ellipse_4" src={Ellipse_4}  /></NavLink>
